...
export function Products() {
  return (
    <div className="bg-background relative">
      ...
      <div className="pt-40 pb-20 border-b border-border bg-grid-pattern relative z-10 bg-white">
      ...
      <div className="py-24 md:py-32 relative z-10 bg-[#F7F8FA]">
            ...
            {allProducts.map((product, index) => (
              ...
              >
                <div className="flex-1 w-full">
                  <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-border shadow-sm text-foreground text-sm font-bold tracking-wide uppercase mb-8">
                    <span className="w-2 h-2 rounded-full bg-primary"></span>
                    {product.category}
                  </div>
                  <h2 className="text-4xl md:text-5xl font-extrabold text-foreground mb-6 flex items-center gap-4 tracking-tight">
                    <div className="p-3 bg-white shadow-sm border border-border rounded-2xl shrink-0">
                  ...
                  <div className="grid sm:grid-cols-2 gap-6 mb-10">
                    {product.features.map((feature, i) => (
                      <div key={i} className="flex items-start gap-3 p-4 rounded-2xl bg-white border border-border shadow-sm">
                ...
                <div className="flex-1 w-full">
                  <Card className="bg-white border-border shadow-xl rounded-[2.5rem] aspect-[4/3] flex items-center justify-center overflow-hidden relative group p-4">
                    ...
                    <div className="relative z-10 w-full h-full bg-white/80 backdrop-blur-md rounded-[2rem] border border-border shadow-sm flex items-center justify-center">
